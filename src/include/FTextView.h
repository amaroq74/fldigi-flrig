...
protected:
	enum {
		...
		VIEW_MENU_SAVE,
		VIEW_MENU_WRAP,
		VIEW_MENU_FONT, VIEW_MENU_COLOR
	};
	...
	static void		cb_font_selected(Fl_Widget*, void*);
	void			select_color();
	void			select_font();
...
protected:
	enum {
		...
		EDIT_MENU_FONT, EDIT_MENU_COLOR
	};
...
private:
	...
	static void cb_edit_font_selected(Fl_Widget* o, void*);
	void select_edit_color();
	void select_edit_font();
