...
Fl_Menu_Item FTextView::menu[] = {
	...
	{ _("Font"), 0, 0, 0, 0, FL_NORMAL_LABEL },
	{ _("Color"), 0, 0, 0, 0, FL_NORMAL_LABEL },
	{ 0 }
};
...
static Font_Browser  *fntSelectbrowser = (Font_Browser *)0;
static FTextView *me = (FTextView *)0;

void FTextView::cb_font_selected(Fl_Widget* o, void*)
{
	if (me) {
		me->setFont( fntSelectbrowser->fontNumber() );
		me->setFontSize (fntSelectbrowser->fontSize() );
		me->setFontColor (fntSelectbrowser->fontColor() );
	}
	fntSelectbrowser->hide();
}

void FTextView::select_font()
{
	if (fntSelectbrowser == (Font_Browser *)0)
		fntSelectbrowser = new Font_Browser;
	fntSelectbrowser->fontNumber( textfont() );
	fntSelectbrowser->fontSize( textsize() );
	fntSelectbrowser->fontColor( textcolor() );
	me = this;
	fntSelectbrowser->callback( cb_font_selected );
	fntSelectbrowser->show();
}

void FTextView::select_color()
{
	uchar red, green, blue;
	Fl::get_color ( color(), red, green, blue );
	if (fl_color_chooser("Background color", red, green, blue)) {
...
static Font_Browser  *fntSelectEditBrowser = (Font_Browser *)0;
static FTextEdit *me2 = (FTextEdit *)0;

void FTextEdit::cb_edit_font_selected(Fl_Widget* o, void*)
{
	if (me2) {
		me2->setFont( fntSelectEditBrowser->fontNumber() );
		me2->setFontSize (fntSelectEditBrowser->fontSize() );
		me2->setFontColor ( fntSelectEditBrowser->fontColor() );
	}
	fntSelectEditBrowser->hide();
}

void FTextEdit::select_edit_font()
{
	if (fntSelectEditBrowser == (Font_Browser *)0)
		fntSelectEditBrowser = new Font_Browser;
	fntSelectEditBrowser->fontNumber( textfont() );
	fntSelectEditBrowser->fontSize( textsize() );
	fntSelectEditBrowser->fontColor( textcolor() );
	me2 = this;
	fntSelectEditBrowser->callback( cb_edit_font_selected );
	fntSelectEditBrowser->show();
}

void FTextEdit::select_edit_color()
{
	uchar red, green, blue;
	Fl::get_color ( color(), red, green, blue );
	if (fl_color_chooser("Background color", red, green, blue)) {
